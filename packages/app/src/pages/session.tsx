...
export default function Page() {
  ...
  const sessionPanelOpen = createMemo(() => layout.session.panel())
  const desktopReviewOpen = createMemo(() => isDesktop() && sessionPanelOpen() && view().reviewPanel.opened())
  const desktopFileTreeOpen = createMemo(() => isDesktop() && sessionPanelOpen() && layout.fileTree.opened())
  ...
  const reviewTab = createMemo(() => isDesktop() && sessionPanelOpen() && !layout.fileTree.opened())
