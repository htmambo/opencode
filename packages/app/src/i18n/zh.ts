...
export const dict = {
  ...
  "settings.config.editor.description": "更改将应用到全局服务器配置。",
  "settings.config.action.format": "格式化 JSON",
  "settings.config.action.reset": "重置为服务器值",
  "settings.config.action.save": "保存配置",
  "settings.config.mode.visual": "可视化",
  "settings.config.mode.json": "JSON",
  "settings.config.toast.invalid.title": "JSON 无效",
  "settings.config.toast.invalid.description": "请检查是否缺少逗号或大括号。",
  "settings.config.empty": "未找到配置项。",
  "settings.config.breadcrumb.root": "根目录",
  "settings.config.nav.back": "返回",
  "settings.config.nav.enter": "打开",
  "settings.config.object.add": "添加字段",
  "settings.config.object.fields": "{{count}} 个字段",
  "settings.config.object.empty": "暂无字段。",
  "settings.config.object.key": "键",
  "settings.config.object.key.placeholder": "字段名",
  "settings.config.object.remove": "移除",
  "settings.config.object.value": "值",
  "settings.config.array.add": "添加项",
  "settings.config.array.items": "{{count}} 项",
  "settings.config.array.empty": "尚未添加任何项。",
  "settings.config.array.item": "第 {{index}} 项",
  "settings.config.array.remove": "移除",
  "settings.config.array.value": "值",
  "settings.config.value.null": "空值",
  "settings.config.value.unsupported": "不支持的值",
  "settings.config.value.set": "设置值",
