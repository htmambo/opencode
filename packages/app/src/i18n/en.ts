export const dict = {
  ...
  "settings.config.description": "Edit and save the global OpenCode config.",
  "settings.config.editor.label": "Config JSON",
  "settings.config.editor.description": "Changes apply to the global server configuration.",
  "settings.config.action.format": "Format JSON",
  "settings.config.action.reset": "Reset to server",
  "settings.config.action.save": "Save config",
  "settings.config.mode.visual": "Visual",
  "settings.config.mode.json": "JSON",
  "settings.config.toast.invalid.title": "Invalid JSON",
  "settings.config.toast.invalid.description": "Check for missing commas or braces.",
  "settings.config.empty": "No config values found.",
  "settings.config.breadcrumb.root": "Root",
  "settings.config.nav.back": "Back",
  "settings.config.nav.enter": "Open",
  "settings.config.object.add": "Add field",
  "settings.config.object.fields": "{{count}} fields",
  "settings.config.object.empty": "No fields available.",
  "settings.config.object.key": "Key",
  "settings.config.object.key.placeholder": "Field name",
  "settings.config.object.remove": "Remove",
  "settings.config.object.value": "Value",
  "settings.config.array.add": "Add item",
  "settings.config.array.items": "{{count}} items",
  "settings.config.array.empty": "No items added yet.",
  "settings.config.array.item": "Item {{index}}",
  "settings.config.array.remove": "Remove",
  "settings.config.array.value": "Value",
  "settings.config.value.null": "Null value",
  "settings.config.value.unsupported": "Unsupported value",
  "settings.config.value.set": "Set value",
